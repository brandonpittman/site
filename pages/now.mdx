...
import Cert from "../public/shift-nudge-certificate.png"
...
I completed the [Shift Nudge](https://shiftnudge.com/) design course! I'm
hoping to position myself as more of a UI/UX design specialist in the future.

<!-- 
  ![Shift Nudge Certificate of Completion](../public/shift-nudge-certificate.png)
 -->

<Image src={Cert} width={1200} height={750} placeholder="blur" />
...
After reading Oliver Burkeman's fantastic <amazon name="4000 weeks">4,000
Weeks</amazon>, I emailed him with praise and he recommended the book <amazon
name="At the Existentialist Cafe">At the Existentialist Cafe</amazon>, which
led me to studying phenomenology. The phenomenological attitude has been
helpful in my efforts to design better software, revamp my personal
productivity, and streamlining things around the house.
