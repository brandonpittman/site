const quotes = [
  {
    ...
    text: `—It’s unfortunate that this has happened.
No. It’s fortunate that this has happened and I’ve remained unharmed by it—not shattered by the present or frightened of the future.`,
  ...
  {
    source: "Meditations (Book 4)",
    text: `In short, know this: Human lives are brief and trivial. Yesterday a blob of semen; tomorrow embalming fluid, ash.`,
  },
  {
    source: "Meditations (Book 4)",
    text: `Suppose that a god announced that you were going to die tomorrow “or the day after.” Unless you were a complete coward you wouldn’t kick up a fuss about which day it was—what difference could it make? Now recognize that the difference between years from now and tomorrow is just as small.`,
  },
  {
    source: "Meditations (Book 4)",
...
But we need to eliminate unnecessary assumptions as well. To eliminate the unnecessary actions that follow.`,
  ...
  {
    source: "Meditations (Book 4)",
    text: `Keep looking closely like that, and embody it in your actions: goodness—what defines a good person.`,
  },
  {
    source: "Meditations (Book 4)",
