...
- Working memory (today's active tasks and thoughts)
- Calendar page at the front (wife's schedule, monthly events)
- Random reference pages (media to consume, BJJ notes, whatever)
...
- Write things down wherever makes sense in the moment
- Notice what gets used together
- Only after patterns emerge do I name them (if at all)
...
Most productivity systems fail because they demand you organize _before_ you understand what you're organizing. They make you commit to a structure before the structure has proven itself through use.
...
This isn't "just be disorganized." It's letting organization emerge from actual use instead of imposing it from theory. Structure still happens - it just happens _after_ you've learned what structure serves you, not before.
...
- No predetermined categories means no friction deciding "where does this go?"
- No elaborate linking ceremonies means thinking doesn't get interrupted by maintenance.
- Physical paper means natural filtering through the cost of rewriting and the constraint of space.
- One notebook means no system to maintain, just a tool to use.
- The system is: there is no system. Just a notebook and the principle that patterns emerge from use, not from planning.
