...
"Compile" comes from the Latin _compilare_—to heap together. Programming borrowed it because compilers gather scattered source files into executables. I use the word exactly as it was intended: gathering raw material into a finished whole.
